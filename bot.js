   ...
   client.on("message", message => {
    if (message.content === "-help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  دا سيرفر :scroll:
         :hearts: الموقع الرسمي للبوت تحت تطوير  :hearts: **`)
   ...
   message.author.sendEmbed(embed)
    ...
    if (message.content === "-help-p") {
     const embed = new Discord.RichEmbed() 
         .setThumbnail(message.author.avatarURL)
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  داسيرفر		 :scroll:
         :hearts: الموقع الرسمي للبوت coming soon  :hearts: **`)
   message.author.sendEmbed(embed)
...
if (message.author.id !== '282066712654774282') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
